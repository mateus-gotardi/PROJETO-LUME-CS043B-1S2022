        ...
        <div className='general'>
            <div className="container height100">
                <div className='noImageBox'>
                    ...
                    <p className='info hoverable second'>"Obteve como resposta que o objeto 'pode ser utilizado em placa de veículo automotor para dificultar que radares de fiscalização eletrônica de trânsito consigam detectar os caracteres impressos na placa'. Era também um indício de que ele queria apagar possíveis rastros da ação”
