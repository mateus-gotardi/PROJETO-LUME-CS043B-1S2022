        ...
        <div className='general'>
            ...
            <div className="container">
                <div className='noImageBox'>
                    <h1 className='finalTitle textCenter'>Quem mandou matar Marielle Franco?</h1>
                    <p className='finalInfo textCenter'>
                        O <Link to='/creditoscs043b1s2022' className='finalInfo linkFinal'>Projeto Lume</Link> surgiu com uma inquietação: dar luz a arquivos de uma história cada vez mais complicada.
                    ...
                    <p className='finalInfo textCenter'>
                        <Link to='/fontescs043b1s2022' className='finalInfo linkFinal'>Conheça as fontes do projeto clicando aqui.</Link>
                    </p>
                </div>
            </div>
